          ...
          <header className="arogya-header">
            ...
            <div className="lang-bar">
              ...
              <div className="lang-pills">
                ...
                <button className={`lang-pill ${lang === 'mr' ? 'active' : ''}`} onClick={() => setLang('mr')}>मरा</button>
              </div>
            </div>

            <div className="alert-marquee">
              <span className="alert-pill">⚠ ALERT</span>
              <marquee scrollamount="4">{t.marqueeAlert}</marquee>
            </div>
            
            <div className="tips-marquee">
              <span>💡</span>
              <marquee scrollamount="3">{t.marqueeTips}</marquee>
            </div>
          </header>
